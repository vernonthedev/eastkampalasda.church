...
<section id="top" class="l-main__content l-grid l-grid--7-col u-shift--left--1-col--at-large l-grid-wrap--6-of-7 u-spacing--double--until-xxlarge u-padding--zero--sides">
  <article class="c-article l-grid-item l-grid-item--l--4-col  post-1385 page type-page status-publish hentry">
    ...
    <h3 class="u-theme--color--darker u-theme--color--darker u-font--primary--m">
          <a href="about-us.php" class="c-block__title-link u-theme--link-hover--dark">
        <strong>Who we are</strong>
          </a>
      </h3>
      <p class="c-block__body text">
      The East Kampala Seventh Day Adventist Church (EKC) is one the latest Adventist Churches founded in Eastern part of Kampala District located in Kira Kimanyi
EKC is a sub-entity of the General Conference of Seventh-day Adventists, which coordinates the Church’s activities in the Eastern part of Africa    </p>
                  <a href="about-us.php" class="c-block__button o-button o-button--outline">Read More<span class="u-icon u-icon--m u-path-fill--base u-space--half--left"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><title>Long right arrow</title><path d="M18.29,8.59l-3.5-3.5L13.38,6.5,15.88,9H.29v2H15.88l-2.5,2.5,1.41,1.41,3.5-3.5L19.71,10Z" fill="#9b9b9b"/></svg>
</span></a>
      </div>
                                                              <div class="c-block c-block__text  u-theme--border-color--darker u-border--left u-spacing--half">
    <h3 class="u-theme--color--darker u-theme--color--darker u-font--primary--m">
          <a href="history.php" class="c-block__title-link u-theme--link-hover--dark">
        <strong>History</strong>
          </a>
      </h3>
      <p class="c-block__body text">
      The Seventh-day Adventist® Church was born out of the Millerite movement of the 1840s when thousands of Christians searched for greater understanding of biblical prophecy. Among these believers was a group in New England that rediscovered the seventh-day Sabbath.    </p>
